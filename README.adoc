...
* Go version 1.21.x (1.21.11 or higher) - download for your development environment https://golang.org/dl/[here].
* Operator SDK v1.36.0 - download for your development environment https://v1-25-x.sdk.operatorframework.io/docs/installation/#install-from-github-release[here]
