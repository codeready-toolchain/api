		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"CompliantUsername": {
						SchemaProps: spec.SchemaProps{
							Description: "The DNS-1123-compliant username.  This username is generated by the registration app and may differ from the Username, as a limited character set is available for naming (see RFC1123).  If the username contains characters which are disqualified, the username is transformed into a compliant name instead. For example, johnsmith@redhat.com -> johnsmith-at-redhat-com",
							Type:        []string{"string"},
							Format:      "",
						},
					},
